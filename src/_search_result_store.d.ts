...
export declare function _search_result_store<I extends unknown = unknown, O extends unknown = unknown>({ query, _data, clear }: search_result_opts_type<I, O>): search_result_store_type<unknown, unknown>;
